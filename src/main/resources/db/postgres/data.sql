...
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Leo', '2000-09-07', 1, 1, 50.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=1);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Basil', '2002-08-06', 6, 2, 30.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=2);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Rosy', '2001-04-17', 2, 3, 80.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=3);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Jewel', '2000-03-07', 2, 3, 75.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=4);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Iggy', '2000-11-30', 3, 4, 40.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=5);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'George', '2000-01-20', 4, 5, 60.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=6);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Samantha', '1995-09-04', 1, 6, 55.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=7);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Max', '1995-09-04', 1, 6, 55.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=8);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Lucky', '1999-08-06', 5, 7, 35.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=9);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Mulligan', '1997-02-24', 2, 8, 90.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=10);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Freddy', '2000-03-09', 5, 9, 35.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=11);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Lucky', '2000-06-24', 2, 10, 70.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=12);
INSERT INTO pets (name, birth_date, type_id, owner_id, care_cost) SELECT 'Sly', '2002-06-08', 1, 10, 50.00 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=13);
